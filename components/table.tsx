                ...
                >
                 {column.key === 'action'? (
                  <div className='flex w-full justify-center gap-2'>
                    <button className="bg-red-100 p-1 rounded-lg fill-amber-950 hover:bg-amber-950 hover:fill-red-100" onClick={() => onEdit!(row.id)}>
                    ...
                    <button className="bg-red-100 p-1 rounded-lg fill-amber-950 hover:bg-amber-950 hover:fill-red-100" onClick={() => onDelete!(row.id)}>
                      <svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
